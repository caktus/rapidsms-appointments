...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'appointments_appointment', 'subscription',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'appointments', null=True, to=orm['appointments.TimelineSubscription']),
                      keep_default=False)
    ...
    models = {
        u'appointments.appointment': {
            ...
            'subscription': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'appointments'", 'null': 'True', 'to': u"orm['appointments.TimelineSubscription']"})
        },
